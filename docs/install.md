...
!!! warning
    We highly recommend you to not disable the cache, as it
...
!!! warning
    Sometimes Redis is a bit outdated in your Linux
...
It is also recommended the use of [supervisor](http://supervisord.org/)
...
You need first to add a user to your [PostgreSQL](http://www.postgresql.org/) DB:

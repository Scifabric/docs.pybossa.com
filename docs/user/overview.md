...
For example, the Flickr importer will allow to import a Flickr album by
...
For example, you can create an [EpiCollect](http://plus.epicollect.net)
...
![Imge](http://i.imgur.com/h6qNDX2.png) :width: 100%
...
In addition, an extra field "user_screen_name" has been added to the
info field:
